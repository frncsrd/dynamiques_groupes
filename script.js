...
function generateGraph() {
    ...
    const width = 450;  // Largeur du conteneur
    const height = 450; // Hauteur du conteneur
    const radius = 200; // Rayon du cercle pour laisser de l'espace
...
// Fonction pour mettre à jour le message dynamique et la couleur de fond en fonction du nombre de participants
...
// Fonction pour mettre à jour le graphe et le message dynamique lorsque l'utilisateur change la valeur du curseur
function updateGraphAndMessage() {
    const numPeople = document.getElementById("numPeople").value;
    updateNumDisplay(numPeople);
    generateGraph();
...
window.onload = function() {
    document.getElementById("numPeople").value = 3; // Définit la valeur initiale du curseur
    updateGraphAndMessage(); // Met à jour l'affichage et le graphe pour 3 participants
}
